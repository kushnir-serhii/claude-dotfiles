// ALMA — Pin file customizer: bottom sheet for choosing icon + color
// for a saved file. Renders at device level; controlled by App.
          ...
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div className="eyebrow" style={{ marginBottom: 3 }}>Customize</div>
                <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{file.name}</div>
              </div>
            </div>
